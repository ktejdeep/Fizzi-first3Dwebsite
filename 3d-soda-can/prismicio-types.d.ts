...
/**
 * Item in *AternatingText → Default → Primary → Text Group*
 */
export interface AternatingTextSliceDefaultPrimaryTextGroupItem {
  /**
   * Heading field in *AternatingText → Default → Primary → Text Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: aternating_text.default.primary.text_group[].heading
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading: prismic.RichTextField;

  /**
   * Body field in *AternatingText → Default → Primary → Text Group*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: aternating_text.default.primary.text_group[].body
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
...
/**
 * Primary content in *AternatingText → Default → Primary*
 */
export interface AternatingTextSliceDefaultPrimary {
  /**
   * Text Group field in *AternatingText → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: aternating_text.default.primary.text_group[]
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */
  text_group: prismic.GroupField<
    Simplify<AternatingTextSliceDefaultPrimaryTextGroupItem>
  >;
}

/**
 * Default variation for AternatingText Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AternatingTextSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<AternatingTextSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *AternatingText*
 */
type AternatingTextSliceVariation = AternatingTextSliceDefault;

/**
 * AternatingText Shared Slice
 *
 * - **API ID**: `aternating_text`
 * - **Description**: AternatingText
 * - **Documentation**: https://prismic.io/docs/slices
 */
export type AternatingTextSlice = prismic.SharedSlice<
  "aternating_text",
  AternatingTextSliceVariation
>;
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Cans_image field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
...
export interface SkyDiveSliceDefaultPrimary {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: sky_dive.default.primary.textsenetence
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  textsenetence: prismic.KeyTextField;
  ...
  flavour: prismic.SelectField<
    "lemonLime" | "grape" | "blackCherry" | "watermleon" | "strawberryLemonade"
  >;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      AternatingTextSlice,
      AternatingTextSliceDefaultPrimaryTextGroupItem,
      AternatingTextSliceDefaultPrimary,
      AternatingTextSliceVariation,
      AternatingTextSliceDefault,
      BigTextSlice,
      BigTextSliceVariation,
      BigTextSliceDefault,
      CarouselSlice,
